...
const Weather: React.FC = () => {
  ...
  const apiKey = '3549fb39ae270e23d51b59a005a825de'; // Получи свой ключ на OpenWeatherMap
  const city = 'Kyiv'; // Укажи нужный город
  ...
  return (
    <div className="text-center">
        <Button variant={"outline"} className='rounded-xl'>POGODA</Button>
